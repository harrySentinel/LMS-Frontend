...
import CheckOutForm from "../Payment/CheckOutForm.tsx" 
type Props = {
    data: any;
    clientSecret:string;
    stripePromise:any;
...
const CourseDetails = ({ data ,stripePromise, clientSecret }: Props) => {
    ...
    return (
        <div>
            <div className='w-[90%] 800px:w-[905] m-auto py-5'>
                <div className='w-full flex flex-col-reverse 800px:flex-row'>
                    <div className='w-full 800px:w-[65%] 800px:pr-5'>
                        ...
                        <div>
                            {data.benefits?.map((item: any, index: number) => (
                                <div
                                    className='w-full flex 800px:items-center py-2' key={index}>
                        ...
                        {data.prerequisites?.map((item: any, index: number) => (
                            <div
                                className='w-full flex 800px:item-center py-2'
                                key={index}
                            >
                                <div className='w-[15px] mr-1'>
                                    <IoCheckmarkDoneOutline size={20} className='text-black dark:text-white' />
                                        ...
                                        <div className='flex'>
                                            <div className='w-[50px] h-[50px]'>
                                                <div className='w-[50px] h-[50px] bg-slate-600 rounded-[50px] flex items-center justify-center cursor-pointer'>
                                                    <h1 className='uppercase tex-[18px] text-black dark:text-white'>
                                            ...
                                            <div className='hidden 800px:block pl-2'>
                                                ...
                                                <small className='text-black dark:text-white-[#ffffff83]'>
                    ...
                    <div className='w-full 800px:w-[35%] relative'>
                        <div className='sticky top-0 left-0 z-50 w-full h-screen'>
                            <CoursePlayer
